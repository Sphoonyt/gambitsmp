...
public class PlayerCardData {
    ...
    public int phantomHitCounter = 0;
    /** When set in the future, this player cannot move (used by Frozen Anchor). Movement is
     *  blocked directly rather than via a potion effect so it can never trigger the vanilla
     *  "jump boost launches you into the sky" glitch that high-amplifier Jump Boost causes. */
    public long frozenUntil = 0L;
    public boolean inWebBoost = false;
    public int lastSpeedDemonAmplifier = -1;
    public int lastLightningAmplifier = -1;
