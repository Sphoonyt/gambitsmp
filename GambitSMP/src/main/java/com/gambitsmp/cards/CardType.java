...
public enum CardType {
    ...
    VAMPIRIC("Vampiric", CardRarity.RARE, false, 10, 1040,
            "Chance on hit to deal 3 extra", "hearts of damage and heal you", "for 3 hearts."),
    ...
    GREEDS_TOUCH("Greed's Touch", CardRarity.RARE, false, 0, 1090,
            "Chance to steal an XP level", "from players you hit.", "Has a short cooldown between procs."),
    ...
    HELLFLAME("Hellflame", CardRarity.UNCOMMON, false, 0, 1130,
            "You deal 10% more damage", "while on fire."),
    ...
    FROZEN_ANCHOR("Frozen Anchor", CardRarity.RARE, false, 0, 1150,
            "Small chance on hit to root", "your opponent in place briefly."),
    ...
    COMBO("Combo", CardRarity.UNCOMMON, false, 0, 1200,
            "Every 3rd hit on the same", "target deals 1 extra heart", "with a blood effect."),
